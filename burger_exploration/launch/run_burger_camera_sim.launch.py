...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(pkg_turtlebot3_gazebo, 'config', 'mapping2.rviz')
    ...
    sdf_path = os.path.join(pkg_turtlebot3_gazebo,'models','turtlebot3_burger_cam','model.sdf')
